...
class GeoTiff(object):
    ...
    def clip_tif_with_grid(self, clip_size, out_dir):
        """
    ...
    def clip_tif_with_shapefile(self, shapefile_path, save_dir):
        """
        clip tif with shapefile, supported polygon, multipolygon
        Args:
            shape file_path:
            save_dir:
    ...
    def mask_tif_with_shapefile(self, shapefile_path, save_path, label=255):
        """
