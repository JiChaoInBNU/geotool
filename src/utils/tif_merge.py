...
import sys
import time
from src.utils.tif_process import write_log
...
# =============================================================================
def Usage():
    print('Usage: tif_merge.py [-o out_filename] [-of out_format] [-co NAME=VALUE]*')
...
def run_merge(args):
    ...
    for fi in file_infos:
        ...
        write_log(int((fi_processed+1) / len(file_infos)*100))

# if __name__ == '__main__':
#     # an example for merge tif
#     import os
#     import glob
#     origin_tif_dir = r'E:\wh_predict_defined'
#
#     total_tif_list = glob.glob(os.path.join(origin_tif_dir, '*.tif'))
#     tif_list = total_tif_list
